# MVH3 experiment history

These are dated experiment notes, including superseded recipes and incomplete
checks. Read [the current code guide](MVH3.md) for architecture and contracts;
use each run's logs and completion report for its actual status.
