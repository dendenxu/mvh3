...
Camera-conditioned MiniMax H3, with zero added trainable parameters and a two-stage short-monocular to long/multiview curriculum on the full WorldGen data mixture. See [the MVH3 guide](docs/MVH3.md) for implementation, recipes, tests, and current training-integration status. The original MiniMax H3 documentation follows.
