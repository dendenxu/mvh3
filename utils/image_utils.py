...
def draw_text_on_image(
    ...
    height: int,
    width: int,
    text: str = "Open your mind.",
    font_path: str = "assets/fonts/maple/maplecn-SemiBold.woff2",
    font_size=24,
    fill="#ffffffff",
    margin=6,
    box_fill="#00000080",
    ...
    # sh = img.shape
    # if img.ndim == 3 and sh[-1] == 1:
    #     img = img[..., 0]
    # if img.ndim == 3 and sh[0] == 1:
    #     img = img[0]
    # if img.ndim == 3 and sh[0] == 3 or sh[0] == 4:
    #     img = img.transpose(1, 2, 0)
    # # if img.ndim == 3 and sh[2] == 3:
    ...
    img = np.array(image)  # solidify the drawing commands
    # if img.ndim == 3 and sh[0] == 3:
    #     img = img.transpose(2, 0, 1)
    # if img.ndim == 3 and (sh[-1] == 1 or sh[0] == 1):
    #     img = img[..., 0:1]
    # img = img.reshape(sh)
    return img / 255
